...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final boolean b = bindService(MediaServiceIntent, mServiceConnection, BIND_AUTO_CREATE);
        /**取得介面*/
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            if (myBinder.isPlaying()) {
                ...
                btPlay.setBackgroundResource(R.drawable.arrow);
            }
    ...
    private void setIsPlayButton(Button bt) {
        if (myBinder.isPlaying()) {
            myBinder.pauseMusic();
            bt.setBackgroundResource(R.drawable.arrow);
        } else {
            myBinder.playMusic();
